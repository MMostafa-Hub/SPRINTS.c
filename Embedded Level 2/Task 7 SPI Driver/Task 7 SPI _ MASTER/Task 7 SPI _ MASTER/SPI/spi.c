...
/*
 * Description : Send the required string through SPI from Master to Slave 
 */
...
/*
 * Description : Receive the required string until the '\r' symbol through SPI from Master to Slave 
 */
